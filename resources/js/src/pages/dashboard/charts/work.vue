<template>
    <v-card>
        <v-card-title class="class-chart-head">Place of work
            <v-autocomplete
        ...
        <v-card-text class="dashboard-main-container">
            <div class="dashboard-inner-container">
                <apexchart v-if="iswork && hasdata" width="800" type="pie" :options="chartOptions" :series="series"></apexchart>
...
export default {
    ...
    methods:{
        getWork(){
            ...
            axios.get(`/admin/get-work?${params}`).then(({data})=>{
                this.series = data
