<template>
    <v-card>
        <v-card-title class="class-chart-head">Gender
            <v-autocomplete
        ...
        <v-card-text class="dashboard-main-container">
            <div class="dashboard-inner-container">
                <apexchart v-if="isgender && hasdata" width="800" type="pie" :options="chartOptions" :series="series"></apexchart>
