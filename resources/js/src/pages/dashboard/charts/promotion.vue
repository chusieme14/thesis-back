<template>
    <v-card >
        <v-card-title class="class-chart-head">Promotion
            <v-autocomplete
                ...
                placeholder="All"
                class="class-year"
                @change="getPromotion(), getCourses()"
                filled
                dense
            ></v-autocomplete>
            <v-autocomplete
        ...
        <v-card-text class="dashboard-main-container">
            <div class="dashboard-inner-container">
                <apexchart v-if="ispromotion && hasdata" width="800" type="pie" :options="chartOptions" :series="series"></apexchart>
...
export default {
    ...
    methods:{
        getPromotion(){
            ...
            axios.get(`/admin/get-promotion?${params}`).then(({data})=>{
                this.series = data
