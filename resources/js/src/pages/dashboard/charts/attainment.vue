<template>
    <v-card>
        <v-card-title class="class-chart-head">Highest Educational Attainment
            <v-autocomplete
                ...
                placeholder="All"
                class="class-year"
                @change="getAttainment(), getCourses()"
                filled
                dense
            ></v-autocomplete>
            <v-autocomplete
        ...
        <v-card-text class="dashboard-main-container">
            <div class="dashboard-inner-container">
                <apexchart v-if="isattainment && hasdata" width="800" type="pie" :options="chartOptions" :series="series"></apexchart>
