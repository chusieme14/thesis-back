...
class DashboardController extends Controller
{
    ...
    public function civilStatus()
    {
        ...
        if(Request()->department_id){
            ...
            if(Request()->batch){
                $temp_array = [
                    'single' => Graduate::whereHas('detail', function($q){$q->where('civil_status', 'Single');})->where('batch', Request()->batch)->count(),
    ...
    public function employmentStatus()
    {
        ...
        if(Request()->department_id){
            ...
            if(Request()->batch){
                $temp_array = [
                    'Contractual' => Graduate::whereHas('detail', function($q){$q->where('employment_status', 'Contractual');})->where('batch', Request()->batch)->count(),
    ...
    public function income()
    {
        ...
        if(Request()->department_id){
            ...
            if(Request()->batch){
                $temp_array = [
                    '1st' => Graduate::whereHas('detail', function($q){$q->where('income', 1);})->where('batch', Request()->batch)->count(),
                    '2nd' => Graduate::whereHas('detail', function($q){$q->where('income', 2);})->where('batch', Request()->batch)->count(),
                    '3rd' => Graduate::whereHas('detail', function($q){$q->where('income', 3);})->where('batch', Request()->batch)->count(),
    ...
    public function timeJobs()
    {
        ...
        if(Request()->department_id){
            ...
            if(Request()->batch){
                $temp_array = [
                    '1st' => Graduate::whereHas('detail', function($q){$q->where('time_jobs', 1);})->where('batch', Request()->batch)->count(),
                    '2nd' => Graduate::whereHas('detail', function($q){$q->where('time_jobs', 2);})->where('batch', Request()->batch)->count(),
                    '3rd' => Graduate::whereHas('detail', function($q){$q->where('time_jobs', 3);})->where('batch', Request()->batch)->count(),
